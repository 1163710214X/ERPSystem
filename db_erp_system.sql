...
CREATE TABLE `customer` (
  ...
  `date` date DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `customerType` int(255) DEFAULT 0,
  `checkin` int(255) DEFAULT 0,
  `money` double default 0,
  `pay`   int(255) default 0,
  `modifyInfo` varchar(255) DEFAULT NULL,
  `deleteInfo` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  unique key (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', '客户1',  '0', '27', '2018-10-23', '13918621282', '0', '0', '0', '0',null, null);
INSERT INTO `customer` VALUES ('11', '客户2',  '0', '26', '2018-10-24', '13565656888', '1', '1','0', '0', null, null);
INSERT INTO `customer` VALUES ('13', '客户3',  '0', '35', '2018-10-24', '18888888888', '0', '0','0', '0', null, null);
INSERT INTO `customer` VALUES ('14', '客户4', '1', '26', '2018-10-24', '13656565666', '1', '0','0', '0', null, null);
INSERT INTO `customer` VALUES ('15', '客户5', '0', '22', '2018-10-24', '18866666666', '0', '0','0', '0', null, null);
