		...
		<ul>
			...
			<li>
				<dl>
					...
					<dd>
						<a href="tjkh" class="active">添加客户</a>
					</dd>
				</dl>
			</li>
						<li>
...
<form action="addCustomer" method="post">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">请输入客户信息</h2>
      </div>
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">客户姓名：</span>
        <input type="text" name="name" class="textbox textbox_225"  placeholder="客户姓名..."/>
       ...
       <li>
        <span class="item_name" style="width:120px;"  name="customerType">客户类型：</span>
        <select class="select"  name="customerType">
          <option name="customerType" value="0">批发客户</option>
          <option name="customerType" value="1">零售客户</option>

        </select>
       </li>
        <li>
        <span class="item_name" style="width:120px;" name="checkin">验证：</span>
        <select class="select" name="checkin">
          <option value="0" name="checkin">通过</option>
         <option value="1" name="checkin">不通过</option>
        </select>
       </li>
       <li>
