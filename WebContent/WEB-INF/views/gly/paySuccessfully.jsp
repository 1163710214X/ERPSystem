...
<body>
	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<section class="mtb">
			      <form action="backToOrderManage" method="post">
					    <input type="submit"  value="返回" class="group_btn" />
				  </form>
		</section>
		...
		<div align="center">
		       <img	src="${pageContext.request.contextPath}/assets/images/paySuccessfully.png" width="380" />
		</div>
      		
		<c:forEach items="${list}" var="list"  varStatus="num">					
					<h1 style=" text-align:center;">id为${list.id},姓名为${list.name},联系方式为${list.phone}的客户在${list.date}完成付款</h1>		
					<h1 style=" text-align:center;">付款金额${money}</h1>	
		</c:forEach>
