		...
		<ul>
			...
			<li>
				<dl>
					...
					<!--当前链接则添加class:active-->
					<dd>
						<a href="khlb" class="active">客户列表</a>
					</dd>
					<dd>
						<a href="tjkh">添加客户</a>
					</dd>
	...
	<section class="rt_wrap content mCustomScrollbar">
		<div class="rt_content">
			<div class="page_title">
				<h2 class="fl">客户列表</h2>
				<a href="tjkh_lwj" class="fr top_rt_btn add_icon">添加新客户</a>
			</div>
			<section class="mtb">
			      <form action="queryCustomerByName" method="post">
				...
				<tbody id="list">
					<c:forEach items="${list}" var="list" varStatus="num">
						<tr>
							...
							<td id="t2" class="center"><c:if test="${list.checkin == 0}">
									<a title="已验证" class="link_icon">&#89;</a>
								</c:if> <c:if test="${list.checkin == 1}">
									<a title="未验证" class="link_icon">&#88;</a>
								</c:if>
							</td>
							<td class="center">
							    <a href="tzup?id=${list.id}" title="编辑"
								class="link_icon">&#101;</a> 
